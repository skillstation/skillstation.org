              ...
              <div className="relative z-10 flex h-full items-center justify-center mx-auto max-w-7xl px-4">
                <div className="container mx-auto ">
                  <div className="max-w-4xl">
                    ...
                    <h2 className="mb-2 text-3xl md:text-5xl w-full font-bold text-white drop-shadow-lg tracking-tight">
                      {slide.title}
                    </h2>
                    ...
                    <div className="flex ">
                      <button className="bg-[#0A57FF] cursor-pointer text-white px-4 py-2 rounded-md text-lg font-bold hover:bg-[#0041F5] transition-colors">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="max-w-7xl mx-auto text-center mb-20">
            ...
            <p className="md:text-xl text-gray-600 leading-relaxed">
              ...
              competitive exam preparation. Founded by IITians from India, with
              contributions from student volunteers at Yale-NUS, UBC, Stanford,
              and MIT, we are committed to empowering young leaders through
              high-quality education that is both affordable and accessible to
              deserving students.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            <h2 className="text-2xl text-gray-400 uppercase tracking-wider font-medium">
              Our Expertise
            </h2>
          </div>
          {/* Features Grid */}
                  ...
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        ...
                        highly personalized coaching initiative designed to help
                        students excel in one of India's toughest entrance
                        exams. Mentored by IITians, this program emphasizes deep
                        conceptual understanding, problem-solving techniques,
                        and strategic preparation.
                      </p>
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        Students receive one-on-one guidance, curated study
                        materials, and participate in interactive doubt-clearing
                        sessions. Our approach goes beyond traditional learning
                        by focusing on analytical thinking, real-world
                        applications, and test-taking strategies.
                      </p>
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        With structured mentorship, rigorous practice tests, and
                        continuous progress tracking, we ensure that students
                        gain the confidence and skills needed to crack JEE
                        Advanced and JEE Mains.
                      </p>
                    </div>
              ...
              <div className="relative bg-gray-900/40 backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-gray-800/50">
                ...
                <div className="space-y-4 md:space-y-6 text-gray-300">
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        The GATE Mentorship Programme at Skill Station provides
                        a structured learning path for students aiming to
                        qualify for the Graduate Aptitude Test in Engineering
                        (GATE). Guided by experienced faculty and GATE toppers,
                        this program covers core engineering concepts,
                        problem-solving methodologies, and time-management
                        strategies.
                      </p>
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        Students benefit from personalized mentorship,
                        topic-wise tests, and hands-on guidance to tackle
                        complex numerical problems efficiently. With a focus on
                        conceptual depth, strategic exam preparation, and
                  ...
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        ...
                        meticulously designed practice platform to help students
                        master the exam format. Covering all core topics, the
                        test series includes subject-wise assessments,
                        full-length mock exams, and detailed performance
                        analytics.
                      </p>
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        Each test is crafted to reflect actual GATE difficulty
                        levels, ensuring students build the confidence and speed
                        needed for the exam. Post-test discussions and expert
                        evaluations help aspirants strengthen their weak areas
                        and refine their answering strategies.
                      </p>
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                  ...
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        ...
                        concepts used in engineering, including linear algebra,
                        calculus, differential equations, and probability.
                      </p>
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        Designed for students preparing for competitive exams
                        and engineering applications, the curriculum focuses on
                        problem-solving techniques, theoretical foundations, and
              ...
              <div className="relative bg-gray-900/40 backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-gray-800/50">
                ...
                <div className="flex items-center gap-4 mb-6 md:mb-8">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-white group-hover:text-yellow-400 transition-colors duration-300">
                    Algorithmic Thinking: A Mathematical Approach to Programming
                  </h3>
                </div>
                ...
                <div className="space-y-4 md:space-y-6 text-gray-300">
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      ...
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        Designed for aspiring developers and software engineers,
                        this course equips participants with the expertise to
                        design, develop, and deploy robust software applications
                  ...
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        ...
                        working with complex computations, simulations, and data
                        visualization. This course provides an in-depth
                        introduction to MATLAB programming, numerical computing,
                      ...
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        ...
                        students learn to apply MATLAB for research, engineering
                        problem-solving, and industrial applications. This
                        course is ideal for engineers, researchers, and
                        professionals looking to enhance their technical
                        computing skills.
                      </p>
                    </div>
                    <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-gray-900 to-transparent group-hover:hidden transition-all duration-300 md:block hidden"></div>
              ...
              <div className="relative bg-gray-900/40 backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-gray-800/50">
                ...
                <div className="space-y-4 md:space-y-6 text-gray-300">
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        Data science and AI heavily rely on statistical methods
                        for model development and analysis. This course delves
                        into advanced statistical techniques, including
                        hypothesis testing, Bayesian inference, regression
                        models, and probabilistic machine learning approaches.
                      </p>
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                  ...
                  <div className="relative">
                    <div className="md:line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                      ...
                      <p className="leading-relaxed text-base md:text-lg transition-all duration-300 group-hover:text-gray-200">
                        ...
                        aspiring for leadership roles, this course provides
                        actionable insights into human psychology, helping
                        individuals develop a strategic and empathetic approach
                        to leadership.
                      </p>
                    </div>
                    <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-gray-900 to-transparent group-hover:hidden transition-all duration-300 md:block hidden"></div>
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-4 mb-16">
              <h2 className="text-2xl text-gray-700 uppercase tracking-wider font-medium">
                Our Expert Mentors
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">Chennai</h3>
                </div>
